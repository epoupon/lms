...
namespace lms::audio::ffmpeg::utils
{
    namespace
    {
        ...
        constexpr std::array audioFormatCapabilities{
            ...
            AudioFormatCapability{ .format = { core::media::Container::MP4, core::media::Codec::AC3 }, .demuxerNames = { "mp4" }, .muxerNames = {} },
            AudioFormatCapability{ .format = { core::media::Container::MP4, core::media::Codec::EAC3 }, .demuxerNames = { "mp4" }, .muxerNames = {} },
            AudioFormatCapability{ .format = { core::media::Container::MP4, core::media::Codec::FLAC }, .demuxerNames = { "mp4" }, .muxerNames = {} },
            AudioFormatCapability{ .format = { core::media::Container::MP4, core::media::Codec::Opus }, .demuxerNames = { "mp4" }, .muxerNames = {} },
