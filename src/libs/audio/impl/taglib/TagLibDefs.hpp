...
#define LMS_TAGLIB_HAS_MP4_EXTENDED_CODECS (((TAGLIB_MAJOR_VERSION > 2) || (TAGLIB_MAJOR_VERSION == 2 && TAGLIB_MINOR_VERSION > 3) || (TAGLIB_MAJOR_VERSION == 2 && TAGLIB_MINOR_VERSION == 3 && TAGLIB_PATCH_VERSION >= 2))) // >= 2.3.2
