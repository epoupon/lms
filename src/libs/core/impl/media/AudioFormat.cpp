...
namespace lms::core::media
{
    namespace
    {
        ...
        constexpr std::array audioFormatEntries{
            ...
            AudioFormatEntry{ .format = { Container::MP4, Codec::AC3 }, .extensions = mp4AacExtensions },
            AudioFormatEntry{ .format = { Container::MP4, Codec::EAC3 }, .extensions = mp4AacExtensions },
            AudioFormatEntry{ .format = { Container::MP4, Codec::FLAC }, .extensions = mp4AacExtensions },
            AudioFormatEntry{ .format = { Container::MP4, Codec::Opus }, .extensions = mp4AacExtensions },
