...
namespace lms::ui
{
    ...
    void Release::refreshView()
    {
        ...
        releaseListHelpers::bindDuration(*this, release);
        releaseListHelpers::bindArtists(*this, release);
        releaseListHelpers::bindPlayQueueController(*this, release, _playQueueController, false);
        releaseListHelpers::bindStarred(*this, release);
        releaseListHelpers::bindDownload(*this, release);
        releaseListHelpers::bindInfo(*this, release);
        releaseListHelpers::bindMbid(*this, release);
        releaseListHelpers::bindReleaseYear(*this, release);
        ...
        db::Track::find(LmsApp->getDbSession(), params, [&](const db::Track::pointer& track) {
            ...
            TrackListHelpers::bindInfo(*entry, track, _filters);
